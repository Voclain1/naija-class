// Month-grid maths for a calendar, shared by the app and the website
// (2026-09-23: the web calendar now shows the same month grid the app does,
// so this moved here rather than being written twice).
//
//
