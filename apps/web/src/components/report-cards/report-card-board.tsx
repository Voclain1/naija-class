...
// report-cards/[armId] — a form teacher's own arm only). `basePath` is the
// picker/board root so "All classes" and per-row "View" links stay correct
// under either route group.
export function ReportCardBoard({ basePath }: { basePath: string }) {
                    ...
                    <TableRow key={reportCard.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center justify-end gap-2">
                          <Link
                            href={`${basePath}/${armId}/${reportCard.id}`}
